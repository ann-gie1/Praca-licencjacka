...
def main():
    ...
    df_all = pd.read_csv("../dane_symulacja_CSDA/wyniki_symulacji_1mln-conc20626.csv")
    ...
    for wybrany_izotop in dostepne_izotopy:
        ...
        plik_wyjsciowy = f"../dane_symulacja_CSDA/symulacja_conc_correct_NEMA_{wybrany_izotop}_20626.nii.gz"
