...
def main():
    print("Wczytywanie wyników symulacyjnych (tylko współrzędnych końcowych)...")
    ...
    df_all = pd.read_csv("../dane_symulacja_CSDA/wyniki_symulacji_1mln-conc.csv")
    ...
    for wybrany_izotop in dostepne_izotopy:
        ...
        # Przygotowanie NumPy arrays zamiast Pythonowych list
