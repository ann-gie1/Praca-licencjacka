...
def main():
    ...
    sciezka_szukania = "../dane_symulacja_cal_gonzales/symulacja_conc_correct_NEMA_*.nii.gz"
    ...
    for input_nifti in pliki_nifti:
        ...
        output_image = f"../dane_symulacja_cal_gonzales/symulacja_max_intensity_slice_corr_conc_{izotop}.png"
