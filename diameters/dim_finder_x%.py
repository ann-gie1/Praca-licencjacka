...
def analyze_spheres_subpixel(input_dirs, output_dir="./diameters", angles_step=5, pixel_spacing=2.5):
    files = []
    for d in input_dirs:
...
input_directories = [
    "./diameters/squares_true/sym_C-G/18F",
    "./diameters/squares_true/sym_C-G/44Sc",
    "./diameters/squares_true/sym_CSDA/18F",
    "./diameters/squares_true/sym_CSDA/44Sc",
]
