...
def main():
    # 2. Definicja ścieżek do plików
    # Zakładamy, że plik NIfTI jest w tym samym folderze co ten skrypt
    base_dir = Path(sys.path[0])
    input_nifti = base_dir / 'nema_volume.nii.gz'
    output_image = base_dir / 'nema_max_intensity_slice.png'
    ...
    if not input_nifti.exists():
        ...
        print("Upewnij się, że uruchomiłeś poprzedni skrypt, aby go wygenerować.")
        return 1
